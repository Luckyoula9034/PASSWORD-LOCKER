...
class TestCredential(unittest.TestCase):
    def setUp(self):
        ...
        self.new_credential = Credential("lucky","oula","0759099034","luckyoula@gmail.com") # create Account object

    
    def test_init(self):
        

        self.assertEqual(self.new_credential.credential_name,"lucky")
        self.assertEqual(self.new_credential.user_name,"oula")
        self.assertEqual(self.new_credential.password,"0759099034")
        self.assertEqual(self.new_credential.email,"luckyoula@gmail.com")
